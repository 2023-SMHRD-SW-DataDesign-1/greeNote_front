...
const Header_diary = () => {
    return (
        <div className='header_diary'>
            ...
            <div className='icon_home'> {/* 홈버튼 아이콘 */}
                <Link to="/" className='button_link'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-house-door icon_home" viewBox="0 0 16 16">
